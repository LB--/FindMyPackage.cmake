...
list(LENGTH _preferred_version_list _preferred_version_length)
list(GET _preferred_version_list 0 ${_package}_VERSION_MAJOR)
if(_preferred_version_length GREATER 1)
	list(GET _preferred_version_list 1 ${_package}_VERSION_MINOR)
	if(_preferred_version_length GREATER 2)
		list(GET _preferred_version_list 2 ${_package}_VERSION_PATCH)
		if(_preferred_version_length GREATER 3)
